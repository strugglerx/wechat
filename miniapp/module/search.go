...
func (a *Search) ImageSearch(file io.Reader, fileName string) (utils.Response, error) {
...
func (a *Search) SiteSearch(body []byte) (utils.Response, error) {
...
func (a *Search) SubmitPages(body []byte) (utils.Response, error) {
